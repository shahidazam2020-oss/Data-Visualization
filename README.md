...
Notice that there is **only ONE closing ` ``` `** after your Repository Structure:

```text
└── superstore.csv

After that, do not put another ``` at the very bottom of the README.
...
So GitHub will display it as plain text with bold emphasis, rather than as a Markdown heading.
